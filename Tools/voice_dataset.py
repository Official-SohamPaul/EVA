...
intents = {
    "greetings": {
        "patterns": ["hello", "hi", "hey", "greetings", "good morning", "good afternoon", "good evening", "hi there", "hey there", "what's up", "hello there","Computer"],
    ...
    "good bye": {
        "patterns": ["bye", "see you later", "good bye", "farewell", "take care", "until next time", "bye bye", "catch you later", "have a good one", "so long",'good night'],
        "responses": ["Goodbye!", "See you later!", "Have a great day!", "Farewell! Take care.", "Good bye! Until next time.", "Take care! Have a wonderful day.", "Bye bye!", "Catch you later!", "Have a good one!", "So long!"]
    },
    "gratitude": {
    ...
    "gemini" : {
        "patterns":['hey gemini','ask gemini','generate text','generate','ask ai'],
        "responses":['Yes gemini is listening you','texts are being generated','asking gemini','accoroding to gemini, ']
    }
}
